        ...
        <div className='flex flex-col sm:flex-row items-center justify-between gap-4'>
          ...
          <div className='flex gap-2'>
            <button
              ...
              className='px-4 py-2 rounded-full bg-gray-800 text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-700 transition-colors text-sm font-medium'
            >
              Previous
            </button>
